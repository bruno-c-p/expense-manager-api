...
public class TituloRequestDTO {
    ...
    private List<CentroDeCustoRequestDTO> centrosDeCusto;
    ...
    public List<CentroDeCustoRequestDTO> getCentrosDeCusto() {
        return centrosDeCusto;
    }

    public void setCentrosDeCusto(List<CentroDeCustoRequestDTO> centrosDeCusto) {
